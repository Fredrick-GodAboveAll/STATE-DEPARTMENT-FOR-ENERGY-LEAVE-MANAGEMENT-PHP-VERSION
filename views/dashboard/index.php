  ...
  <div class="card-body p-3">
    <p class="fs-10 mb-0">
      <a href="https://prium.github.io/falcon/v3.25.0/widgets.html#!">
       ...
       Welcome, <strong> <%= userFirstName %></strong> <%= userLastName %></a>. 
       Your work is ready for you <strong>Monday, September <b>4<sup>th</sup></b> </strong></p>
         ...
         <div class="row g-3 mb-3">
              ...
              <div class="card h-70">
                <div class="card-body">
                  <div class="row flex-between-center">
                      ...
                      <h6 class="mb-md-0 mb-lg-2">Employees</h6><span class="badge rounded-pill badge-subtle-success"><span class="fas fa-caret-up"></span> 61.8%</span>
                      </div>
                      <div class="col-auto">
                      <h4 class="fs-6 fw-normal text-700" data-countup='{"endValue":82.18,"decimalPlaces":2,"suffix":"M","prefix":"$"}'>250</h4>
                      </div>
                  </div>
                  </div>
              </div>
              ...
              <div class="card h-70">
                <div class="card-body">
                  <div class="row flex-between-center">
                      ...
                      <div class="col d-md-flex d-lg-block flex-between-center">
                      <h6 class="mb-md-0 mb-lg-2">Departments</h6><span class="badge rounded-pill badge-subtle-success"><span class="fas fa-caret-up"></span> 61.8%</span>
                      </div>
                      <div class="col-auto">
                      <h4 class="fs-6 fw-normal text-700" data-countup='{"endValue":82.18,"decimalPlaces":2,"suffix":"M","prefix":"$"}'>250</h4>
                      </div>
                    ...
                    <div class="card-body">
                      <div class="row flex-between-center g-0">
                        <div class="col-6 d-lg-block flex-between-center">
                          <h6 class="mb-2 text-900">On-leave</h6>
                          <h4 class="fs-7 fw-normal text-700 mb-0">20</h4>
                        ...
                        <div class="col-auto h-100">
                              <div style="height:45px;min-width:80px;" class="echart-bar-weekly-sales h-100 echart-bar-weekly-sales-smaller-width"></div>
                            </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card h-70">
                <div class="card-body">
                  <div class="row flex-between-center">
                      ...
                      <div class="col d-md-flex d-lg-block flex-between-center">
                      <h6 class="mb-md-0 mb-lg-2">On-Leave</h6>
                      <span class=" fs-9.5 badge rounded-pill badge-subtle-success">
                        <span class="fas fa-caret-up"></span> 
                         14
                      </span>
                      </div>
            ...
            <div class="col-md-4 ">
              <div class="card ">
                <div class="card-header pb-0">
                  <h6 class="mb-0 mt-2 d-flex align-items-center"> Departments
                    <span class="ms-1 text-400" data-bs-toggle="tooltip" data-bs-placement="top" title="Calculated according to last week's sales"><span class="far fa-question-circle" data-fa-transform="shrink-1"></span></span></h6>
                </div>
                <div class="card-body">
                  <h6>nice</h6>
                </div>
            ...
            <div class="col-md-4">
              <div class="card ">
                <div class="card-header pb-0">
                  <h6 class="mb-0 mt-2 d-flex align-items-center"> On-Leave<span class="ms-1 text-400" data-bs-toggle="tooltip" data-bs-placement="top" title="Calculated according to last week's sales"><span class="far fa-question-circle" data-fa-transform="shrink-1"></span></span></h6>
                </div>
                <div class="card-body">
                  <h6>nice</h6>
                </div>
                    ...
                    <div class="col-5 col-sm-6 col-xxl pe-2">
                      ...
                      <div class="fs-11 mt-3">
                        <div class="d-flex flex-between-center mb-1">
                          <div class="d-flex align-items-center"><span class="dot bg-primary"></span><span class="fw-semi-bold">Employees</span></div>
                          <div class="d-xxl-none">250</div>
                        </div>
                        <div class="d-flex flex-between-center mb-1">
                          <div class="d-flex align-items-center"><span class="dot bg-info"></span><span class="fw-semi-bold">Administration</span></div>
                          <div class="d-xxl-none">100</div>
                        </div>
                        <div class="d-flex flex-between-center mb-1">
                          <div class="d-flex align-items-center"><span class="dot bg-300"></span><span class="fw-semi-bold">Techinical</span></div>
                          <div class="d-xxl-none">150</div>
                        </div>
                      </div>
                    </div>
                    <div class="col-auto position-relative">
                      <div class="echart-market-share"></div>
                      <div class="position-absolute top-50 start-50 translate-middle text-1100 fs-7">250</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card ">
                ...
                <div class="card-body d-flex flex-column justify-content-end">
                  <div class="row justify-content-between">
                    <div class="row col-auto align-self-end">
                      <span>hey</span>
